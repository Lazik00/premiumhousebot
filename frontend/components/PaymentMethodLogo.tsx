...
const sizeMap: Record<NonNullable<PaymentMethodLogoProps['size']>, CSSProperties> = {
    sm: { width: 42, height: 28, borderRadius: 10, padding: '4px 8px' },
    md: { width: 56, height: 36, borderRadius: 12, padding: '6px 10px' },
    lg: { width: 72, height: 44, borderRadius: 14, padding: '8px 12px' },
};
...
function MastercardLogo() {
    return (
        <svg viewBox="0 0 120 32" width="100%" height="100%" aria-hidden="true">
            ...
            <text x="56" y="20" fontSize="12" fontWeight="700" fontFamily="Arial, sans-serif" fill="#F5F0E6">
                mastercard
            </text>
        </svg>
    );
...
function HumoLogo() {
    return (
        <svg viewBox="0 0 120 32" width="100%" height="100%" aria-hidden="true">
            <defs>
                <linearGradient id="humoGradient" x1="0%" y1="0%" x2="100%" y2="100%">
                    <stop offset="0%" stopColor="#19D58F" />
                    <stop offset="52%" stopColor="#10B7E8" />
                    <stop offset="100%" stopColor="#3E62FF" />
                </linearGradient>
            </defs>
            <rect x="2" y="7" width="38" height="5" rx="2.5" fill="url(#humoGradient)" />
            <rect x="2" y="14" width="38" height="5" rx="2.5" fill="#31D08C" />
            <rect x="2" y="21" width="38" height="5" rx="2.5" fill="#0FA2FF" />
            <text x="49" y="21" fontSize="15" fontWeight="900" fontFamily="Arial, sans-serif" fill="#F5F0E6" letterSpacing="0.04em">
                HUMO
            </text>
        </svg>
    );
...
function UzcardLogo() {
    return (
        <svg viewBox="0 0 120 32" width="100%" height="100%" aria-hidden="true">
            ...
            <text x="46" y="20" fontSize="14" fontWeight="900" fontFamily="Arial, sans-serif" fill="#F5F0E6" letterSpacing="0.04em">
                UZCARD
            </text>
        </svg>
    );
    ...
    return (
        <div
            style={{
                ...
                background: 'linear-gradient(180deg, rgba(255,255,255,0.98), rgba(245,238,226,0.92))',
